...
def setup_teardown():
    ...
    logging.info("*** setup_teardown - TestUart()  ***")
    test = TestUart()
    yield test
# -----------------------------
...
class TestUart:
    ...
    def uart_set_loopback_mode(self, uart_id, mode):
        TestSiteInternal.SetProperty(PropertyType.TER_PropertyType_UartConfiguration, [UartProperty.UartPropertyLoopbackMode, uart_id, mode])

    def uart_set_data_generator_mode(self, uart_id, mode):
        TestSiteInternal.SetProperty(PropertyType.TER_PropertyType_UartConfiguration, [UartProperty.UartPropertyTestDataGeneratorMode, uart_id, mode])
    ...
    def uart_get_polling_mode(self, uart_id):
        return TestSiteInternal.GetProperty(PropertyType.TER_PropertyType_UartConfiguration, 1, [UartProperty.UartPropertyPollingMode, uart_id])[0]

    def uart_set_polling_mode(self, uart_id, mode):
        TestSiteInternal.SetProperty(PropertyType.TER_PropertyType_UartConfiguration, [UartProperty.UartPropertyPollingMode, uart_id, mode])
